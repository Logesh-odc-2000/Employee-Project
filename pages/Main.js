    ...
    <div className="bg-white">
      <header>
        <Popover className="relative bg-white">
          ...
          <div className="flex justify-start lg:w-0 lg:flex-1">
              <h4 className='text-5xl overline text-aqua text-sky-900'>SCRooLeR</h4>
            </div>
            ...
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
              {/* <Session /> */}
              <Link href={'/Dashboard'}>
              <button  className='text-white bg-blue-500 hover:bg-gradient-to-bl  focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-20 py-2.5 text-center mr-2 mb-2 '>Go To Emp</button>  
              </Link>
            </div>
          </div>
      ...
      <main>
        ...
        <div className="relative">
          <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gray-00" />
      ...
      <footer className="bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-200
